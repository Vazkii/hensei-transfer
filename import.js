...
function __weapons(ctx, weapons) {
    ...
    const axMapping = ['1589', '1591', '1596', '1597', '1588', '1590', '1588', '1593', '1595', '1601', '1588', '1590', '1593', '1595', '1600', '1591', '1589', '1594', '1599', '1600', '1592', '1591', '1594', '1596', '1597', '1589', '1591', '1592', '1722', '1719', '1590', '1721', '1593', '1595', '1601', '1588', '1721', '1593', '1595', '1600', '1591', '1592', '1719', '1720', '1600', '1592', '1720', '1722', '1600', '1601', '1589', '1591', '1596', '1597', '1588', '1590', '1588', '1593', '1595', '1601', '1588', '1590', '1593', '1595', '1600', '1591', '1589', '1594', '1599', '1600', '1592', '1591', '1594', '1596', '1597', '1837', '1838'];
        ...
        if(wpId.length > 0) {
            ...
            if('ax' in obj) {
                ...
                for(k2 in ax) {
                    var axObj = ax[k2];
                    var axId = axObj['id'];
                    var axMod = axMapping.findIndex((elm) => elm == axId);
                    var putKey = parseInt(k2) + 1;

                    axPut[`ax_modifier${putKey}`] = axMod;
                    axPut[`ax_strength${putKey}`] = axObj['val'];
                }
